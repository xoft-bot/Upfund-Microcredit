...
import { createClient, createLoanApplication, decideApplication, disburseLoan, getPortalOverview, submitLoanApplication, type PortalApplication, type PortalOverview } from '../../services/api.js';
...
function ApplicationRow({ application, action, actionLabel, busy }: { application: PortalApplication; action?: (application: PortalApplication) => void; actionLabel?: string; busy: boolean }) {
