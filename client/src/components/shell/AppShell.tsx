...
export type ShellOutletContext = QueueCountsState & { role: Role; countsEnabled: boolean };
...
export function AppShell({ identity, email, backendLive, identityError, onSignOut, getToken, versionLabel }: ShellProps) {
  ...
  const context: ShellOutletContext = { ...queueCounts, role, countsEnabled: enabled };
