...
export function registerTelemetryRoutes(app: FastifyInstance, verifier?: TokenVerifier): void {
  const protectedTelemetry = [authMiddleware(verifier), requireRoles(['admin', 'manager', 'accountant'])];
